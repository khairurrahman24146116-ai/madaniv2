...
<div class="bg-surface-container-lowest rounded-xl shadow-lg border border-surface-container-high overflow-hidden animate-scale-in">
    ...
    <div class="bg-white p-8 flex flex-col items-center justify-center text-center rounded-t-xl">
        <x-app-logo size="lg" class="mb-4 animate-pop" />
        <h1 class="font-headline-lg-mobile text-headline-lg-mobile md:font-headline-lg md:text-headline-lg text-primary font-bold animate-fade-up">
            SIAKAD
        </h1>
        <p class="font-title-lg text-title-lg text-on-surface-variant opacity-90 mt-1 animate-fade-up stagger-delay" style="--stagger: 1">
