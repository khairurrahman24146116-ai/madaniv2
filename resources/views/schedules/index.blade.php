    ...
    <table class="w-full text-left border-collapse">
        ...
        <tbody class="divide-y divide-outline-variant">
            ...
            <tr class="hover:bg-surface-container-low transition-colors">
                <td class="px-lg py-md text-body-md text-on-surface">{{ ucfirst($s['day']) }}</td>
                <td class="px-lg py-md text-body-md text-on-surface">{{ $s['start_time'] }} - {{ $s['end_time'] }}</td>
                <td class="px-lg py-md text-body-md text-on-surface font-medium">{{ $s['subject'] }}</td>
                <td class="px-lg py-md text-body-md text-on-surface-variant">{{ $s['teacher'] }}</td>
                <td class="px-lg py-md text-body-md text-on-surface-variant">{{ $s['class'] ?? $s['teacher_short'] }}</td>
                <td class="px-lg py-md text-body-md text-on-surface-variant">{{ $s['room'] }}</td>
            </tr>
            @empty
            <tr>
