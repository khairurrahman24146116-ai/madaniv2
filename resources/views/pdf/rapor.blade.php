...
<head>
    ...
    <style>
        ...
        .header h1 { margin: 0; font-size: 16pt; color: #1a5276; }
        .header h2 { margin: 5px 0; font-size: 13pt; color: #555; }
        .header p { margin: 2px 0; font-size: 10pt; color: #777; }
        ...
        table.subjects th { background: #1a5276; color: #fff; padding: 8px 5px; text-align: center; }
        table.subjects td { padding: 6px 5px; border-bottom: 1px solid #ddd; text-align: center; }
        table.subjects tr:nth-child(even) { background: #f9f9f9; }
        ...
        .grade-null { color: #bbb; }
        .summary { margin-top: 20px; padding: 15px; background: #f0f4f8; border-radius: 5px; font-size: 10pt; }
        .summary table { width: 100%; }
        .summary td { padding: 3px 10px; }
        .summary td:first-child { font-weight: bold; width: 200px; }
        .footer { text-align: center; margin-top: 30px; font-size: 9pt; color: #999; border-top: 1px solid #ddd; padding-top: 10px; }
...
<body>
        ...
        <table>
            ...
            <tr><td>Ringkasan Absensi</td>
                <td>:
                    ...
                    <span style="font-size:9pt;color:#666;">Total: {{ $attendance['total'] }} hari</span>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="footer">
        ...
        <em>Dokumen ini sah dan diproses secara elektronik melalui Sistem Informasi Manajemen SMA Dayah Madani Al-Aziziyah (Madani-SMS)</em>
    </div>
</body>
</html>
