...
<div class="flex flex-col items-center justify-center min-h-[60vh] text-center">
    ...
    <h1 class="text-headline-xl font-bold text-on-surface mt-md">403</h1>
    <p class="text-body-lg text-on-surface-variant mt-sm">Akses Ditolak</p>
    <p class="text-body-md text-on-surface-variant mt-xs mb-xl">Anda tidak memiliki izin untuk mengakses halaman ini.</p>
