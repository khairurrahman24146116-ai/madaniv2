...
<div class="flex flex-col items-center justify-center min-h-[60vh] text-center">
    ...
    <h1 class="text-headline-xl font-bold text-on-surface mt-4">500</h1>
    <p class="text-body-lg text-on-surface-variant mt-2">Terjadi Kesalahan Server</p>
    <p class="text-body-md text-on-surface-variant mt-1 mb-8">Maaf, terjadi kesalahan pada server. Silakan coba lagi nanti.</p>
