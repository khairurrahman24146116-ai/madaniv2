    ...
    <div class="w-full md:w-1/2 min-h-screen flex items-center justify-center px-4 py-8">
        <div class="w-full max-w-[400px]">
            ...
            <div class="bg-white border border-[#c3c6d7] rounded-xl p-8 shadow-sm">
                <form method="POST" action="<?php echo e(route('auth.login.web')); ?>" class="space-y-5">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\madani-al-aziziyah\resources\views/welcome.blade.php ENDPATH**/ ?>